(function ($) {
    var dlabChartlist = (function () {
        ...
        var donutChart1 = function () {
            $("span.donut1").peity("donut", { width: "70", height: "70" });
        };
        ...
        var revenueMap = function () {
            var options = {
                series: [
                    { name: "Net Profit", data: [20, 40, 20, 30, 50, 40, 60] },
                ],
        ...
        var columnChart = function () {
            var options = {
                series: [
                    { name: "Aplication Sent", data: [0, 0, 0, 0] },
                    { name: "Appllication Answered", data: [0, 0, 0, 0] },
                    { name: "Hired", data: [2, 0, 2, 0] },
                ],
                chart: {
                    type: "bar",
                    height: 150,
        ...
        var NewCustomers1 = function () {
            ...
            var chartBar1 = new ApexCharts(
                document.querySelector("#NewCustomers1"),
                options
            );
            chartBar1.render();
        };
        ...
        var emailchart = function () {
            var options = {
                ...
                responsive: [
                    { breakpoint: 1800, options: { chart: { height: 200 } } },
                    { breakpoint: 1800, options: { chart: { height: 200 } } },
                ],
            };
            var chart = new ApexCharts(
