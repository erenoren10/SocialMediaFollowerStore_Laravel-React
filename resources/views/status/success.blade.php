...
<head>
    ...
    <title>Ödeme İşlemi Başarılı</title>
            ...
            <div class="col-rt-12">
                <div class="Scriptcontent"> <!-- partial:index.partial.html -->
                    <div id='card' class="animated fadeIn">
                        ...
                        <div id='lower-side'>
                            <p id='message'>Ödeme adımını başarıyla tamamladınız. Siparişinizin gönderimi kısa süre
                                içerisinde tamamlanacaktır.</p> <a href="{{ route('not.found') }}" id="contBtn">Devam
                                Et</a>
                        </div>
                    </div>
                </div>
