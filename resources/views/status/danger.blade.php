...
<head>
    ...
    <title>Ödeme İşlemi Başarısız</title>
            ...
            <div class="col-rt-12">
                <div class="Scriptcontent"> <!-- partial:index.partial.html -->
                    <div id='card' class="animated fadeIn">
                        ...
                        <div id='lower-side'>
                            <p id='message'>Ödeme adımı tamamlanamadı. Ana sayfaya dönerek siparişinizi
                                tekrarlayabilirsiniz.</p> <a href='{{ route('not.found') }}' id="contBtn">Tekrar
                                Dene</a>
                        </div>
                    </div>
                </div>
